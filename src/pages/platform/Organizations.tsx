          ...
          <ResponsiveTable
            columns={[
              ...
              },
              {
                ...
                mobileOrder: 3,
                render: (org) => (
                  <span className="text-xs text-brand-text-muted whitespace-nowrap">{org.plan}</span>
                ),
              },
              {
                key: "activeEvents",
              ...
              },
              {
                ...
                mobileOrder: 6,
                render: (org) => (
                  <span className="text-xs text-brand-text-muted whitespace-nowrap">{org.country}</span>
                ),
              },
              {
                key: "dateJoined",
                ...
                mobileOrder: 7,
                render: (org) => (
                  <span className="text-[10px] font-mono text-brand-text-muted whitespace-nowrap">
            ...
            data={filtered}
            keyExtractor={(org) => org.organizationId}
            onRowClick={(org) => navigate(`/platform/organizations/${org.organizationId}`)}
          />
        </motion.div>
      )}
    </div>
