...
export default function ResetPasswordPage() {
  ...
  if (!token) {
    return (
      <AuthLayout title="Reset Password" subtitle="Invalid or missing reset token." variant="platform">
        <SeoHead meta={{ title: "Reset Password — ORIVIS", noindex: true }} />
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await authService.resetPassword(token, email.trim(), password);
  ...
  if (pageState === "success") {
    return (
      <AuthLayout title="Password Reset" subtitle="Your password has been updated." variant="platform">
        <SeoHead meta={{ title: "Password Reset — ORIVIS", noindex: true }} />
        <AuthCard className="!shadow-none !bg-transparent !border-none !p-0 !backdrop-blur-none !max-w-none">
          <AuthStateCard
            state="success"
  ...
  return (
    <AuthLayout title="Reset Password" subtitle="Enter your new password below." variant="platform">
      <SeoHead meta={{ title: "Reset Password — ORIVIS", noindex: true }} />
      <AuthCard className="!shadow-none !bg-transparent !border-none !p-0 !backdrop-blur-none !max-w-none">
