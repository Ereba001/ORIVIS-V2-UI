...
export default function EmptyState({ icon: Icon = Inbox, title, description, action }: Props) {
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center py-16 px-4 sm:px-6 text-center"
    >
      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-brand-surface-elevated flex items-center justify-center mb-4 text-brand-text-muted">
        <Icon size={28} />
      </div>
