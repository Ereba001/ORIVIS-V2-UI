...
export default function LoadingOverlay({ messages, delay = 600 }: Props) {
  return (
    <AnimatePresence>
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <motion.div
          ...
          className="bg-brand-surface border border-brand-border rounded-2xl p-8 max-w-sm w-full mx-4 shadow-2xl"
        >
